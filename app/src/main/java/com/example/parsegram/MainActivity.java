        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if(e != null){
                    ...
                    Toast.makeText(MainActivity.this, "Error while saving, Issue with creating post", Toast.LENGTH_SHORT).show();
                    return;
                }
                Log.i(TAG, "Post was saved");
                Toast.makeText(MainActivity.this, "Post was created!", Toast.LENGTH_SHORT).show();
